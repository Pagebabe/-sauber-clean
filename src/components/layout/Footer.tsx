/**
 * Footer Component - Main footer for PW Pattaya
 *
 * Features:
 * - Desktop: 4 columns (Company, Links, Properties, Contact)
 * - Mobile: Stacked sections
 * - Dark background (#1a2c3d accent color)
 * - Social media links
 * - Copyright text
 *
 * @example
  ...
  return (
    <footer className="bg-accent text-white py-16">
      <div className="container mx-auto px-6">
        ...
        {/* Social Media Links */}
        <div data-testid="footer-social" className="flex gap-4 mb-8 pt-8 border-t border-white/10">
          <a
