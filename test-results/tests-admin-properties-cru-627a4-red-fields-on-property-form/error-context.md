              ...
              - generic [ref=e27]:
                ...
                - generic [ref=e30]:
                  ...
                  - link "Learn more about enabling Node.js inspector for server code with Chrome DevTools" [ref=e37] [cursor=pointer]:
                    ...
                    - img [ref=e38]
              - generic [ref=e47]: "Error serializing `.session.user.image` returned from `getServerSideProps` in \"/admin/properties/[id]\". Reason: `undefined` cannot be serialized as JSON. Please use `null` or omit this value."
            - generic [ref=e50]:
              - paragraph [ref=e51]:
                - text: Call Stack
                - generic [ref=e52]: "29"
              - button "Show 29 ignore-listed frame(s)" [ref=e53] [cursor=pointer]:
